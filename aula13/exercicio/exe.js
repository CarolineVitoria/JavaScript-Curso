...
const excluindoEspaco = nome.replace(/\s/g, '');

document.body.innerHTML += `Seu nome é: <strong>${nome}</strong> <br />`;
document.body.innerHTML += `Seu nome tem <strong>${excluindoEspaco.length}</strong> letras <br />`;
...
document.body.innerHTML += `As últimas 3 letras do seu nome são: <strong>${excluindoEspaco.slice(-3)}</strong> <br />`;
